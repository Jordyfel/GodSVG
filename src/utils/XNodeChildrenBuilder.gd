...
static var ElementFrameScene: PackedScene = load("res://src/ui_widgets/element_frame.tscn")
static var BasicXNodeFrameScene: PackedScene = load("res://src/ui_widgets/basic_xnode_frame.tscn")
